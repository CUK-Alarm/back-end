...
<img src= "https://velog.velcdn.com/images/hyuntae99/post/c408e2a8-fb75-4eef-ad8f-e4bda782d79c/image.gif" width="800" height="400"> <img src = "https://github.com/CUK-Alarm/back-end/assets/101180610/174bd414-859e-4e6b-8fcf-e69404d7e718" width="200" height="400">
<br><br>
...
## 8. 개발자 모드 (유료 서비스 이용)
현재 공지사항을 메세지를 보내게되면 장문 메세지로 변환되는데 LMS의 API 가격이 부담되어 루트 계정에만 사용하도록 결정했습니다.<br>
우측 하단의 개발자 모드를 클릭하여 특정 코드를 입력하면 루트 계정으로 변환되어 문자 메세지로도 알림을 받을 수 있습니다.
...
하지만 이번에는 유저가 가장 가까운 핸드폰이라는 통신 기기를 통해서 인증을 진행했기 때문에 안전성이 높아진 것 같습니다. <br>**
...
**3. 제가 개발한 REST API를 사용해서 직접 웹페이지에 나타내는 작업을 통해서 프론트 개발자분들의 고충을 조금이나마 이해했고 <br>
